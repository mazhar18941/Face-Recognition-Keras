...
1. weights of vgg_facenet model can be downloaded from [here](https://drive.google.com/file/d/1CPSeum3HpopfomUEK1gybeuIVoeJT_Eo/view?usp=sharing).After weights file is downloaded, place it in [weights](weights) folder.
...
5. Now, put images of your friends or family members in [database_images](database_images) folder. Be sure that
